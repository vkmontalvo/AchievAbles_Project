...
// Include database connections
        ...
        if (isPost()) {
                ...
                updateGoal($_SESSION['goal'],$goalTitle,$category,$goalImg,$description);
                
                $_SESSION['message'] = 'Goal updated!';
        ...
        <div class='container-fluid'>
            ...
            <br />
            <br />
            <form method="post" action="editgoal.php">
            <div class="goal">
                <div class="left-content">
                    <img src="images/goal.png" class="goal-img" /><br />
                    <label for ="goal-image" class="labels">Image URL</label><br />
                    <input type="text" name="goal-image" class="img-entry" value="<?php echo $goalarray['goal_img']; ?>"/>
                ...
                <div class="goal-content">
                    ...
                    <input type="text" name="title" class="edit-entries" value="<?php echo $goalarray['goal_title']; ?>"/>
                    ...
                    <textarea name='goal-descrip' class='text-area'>value="<?php echo $goalarray['goal_descrip']; ?>"</textarea><br />
